...
- `-v <path/to/media>:/data` This is provided as examples for providing media into the container.  You must have your media folders as subfolders of `/data` or else you will not be able to properly access your data in some configurations. For example you may mount your `/volume1/tv` folder as `/data/tv`. You can use as many or as few of these `-v` parameters as required to match your media directories to the container.
